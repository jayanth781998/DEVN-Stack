...
const list = async () => {
  ...
  await axios
    .get(`http://localhost:5000/view/${resu.params.tname}`)
    .then((res) => {
...
const deleter = async (ls, ds) => {
  ...
  console.log(payload.value);
  await axios
    .post(`http://localhost:5000/del/${resu.params.tname}`, payload.value)
    .then((res) => {
      console.log(res.data);
...
const updater = async (z) => {
  ...
  await axios
    .post(`http://localhost:5000/update/${resu.params.tname}`, payloadup.value)
    .then((res) => {
      console.log(res.data);
